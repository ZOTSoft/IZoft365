...
foreach($source_tables as $tbl_name)
{
    if(in_array($tbl_name, $target_tables))
    {
        ...
        if($raw_source_columns !== $raw_target_columns){
            //print_r($raw_source_columns); 
            //print_r($raw_target_columns); 
...
unset($raw_source_tables); 
unset($raw_target_tables);
unset($source_tables);
unset($target_tables);
unset($raw_source_columns);
unset($raw_target_columns);
