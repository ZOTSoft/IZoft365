...
<head>
    ...
    <script type="text/javascript" src="/company/tree/mytreeview.js"></script>
    <script type="text/javascript" src="/company/js/jquery.form.min.js"></script>
    <script type="text/javascript" src="/company/tree/init.js"></script>
    <script type="text/javascript" src="/company/tree/warehouse.js"></script>
                    ...
                    <ul>
                        ...
                        <li>Отчеты
                            <ul>
                                ...
                                <? if (checkrights('gethtml_remains',1)){?><li><a href="#" onclick="show_otchet2('gethtml_anal_sale')">Анализ продаж</a></li><?}?>
