                ...
                return{title: c.lang.image["image" == j ? "title" : "titleButton"], minWidth: 420, minHeight: 360, onShow: function() {
                        ...
                        delete this.imageElement
                                ...
                                {type: "hbox", children: [{id: "basic", type: "vbox", children: [{type: "hbox", requiredContent: "img{width,height}", widths: ["50%", "50%"], children: [{type: "vbox", padding: 1, children: [{type: "text", width: "45px", id: "txtWidth", label: c.lang.common.width, onKeyUp: w, onChange: function() {
                                    ...
                                    }}, {type: "button", id: "browse", hidden: 0, filebrowser: {action: "Browse", /*target: "Link:txtUrl", url: c.config.filebrowserImageBrowseLinkUrl*/ onSelect: function (fileUrl, data) {alert( 'The selected file URL is "' + fileUrl + '"' ); } }, style: "float:right", label: c.lang.common.browseServer}, {id: "cmbTarget", type: "select", requiredContent: "a[target]", label: c.lang.common.target, "default": "", items: [[c.lang.common.notSet, ""], [c.lang.common.targetNew, "_blank"], [c.lang.common.targetTop, "_top"], [c.lang.common.targetSelf, "_self"], [c.lang.common.targetParent, "_parent"]], setup: function(a, b) {
